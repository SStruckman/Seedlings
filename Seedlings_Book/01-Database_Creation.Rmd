...
### Raster Data
In addition to the tabular data above, I will likely also be using some geospatial raster data for physical and topographical information on the plot.


## Database Creation
Here we create a database to store out tabular data in one place.
